...
3. activities 필드별 역할: 교사=교사 발문·할 말만. 학생=학생 예상 반응·할 말만. 자료=사진·PPT 등 자료명. 유의점=지도 시 유의사항. 평가=(관찰) 등. 서로 섞지 말 것.
...
- evaluationPlan: 평가 계획 표. 범주(평가방법), 평가요소, 수준(상/중/하), 피드백 포함. 1~3행.
{
  ...
  "model": "교수·학습 모형",
  "activities": [
    { "단계": "도입", "형태": "전체", "활동": "활동 요약", "교사": "교사 발문·할 말", "학생": "학생 예상 반응", "시간": "3", "자료": "자료명", "유의점": "유의사항", "평가": "(관찰)" },
