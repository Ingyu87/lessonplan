...
1. 해당 차시 "주요 학습 내용 및 활동"이 핵심. 이 내용을 축약·변형하지 말고 그대로 반영.
2. 그 차시별 주요 활동과 직접 관련된 성취기준·핵심아이디어만 선택. 해당 차시와 무관한 내용(예: '관점', '다양한 관점')은 넣지 않음.
3. 차시별 주요 활동을 해결하기 위한 탐구질문을 만듦.
