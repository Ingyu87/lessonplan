...
[필수 반영 사항]
1. **연간지도 계획**에 제시된 해당 차시의 "주요 학습 내용 및 활동"을 이 차시 수업의 **핵심 목표**로 삼으세요. 교수·학습 활동: **도입 1행, 전개 3행(활동1·활동2·활동3), 정리 1행** 총 5행으로 작성하세요.
...
- **교수·학습 활동**은 총 5행으로 구성: **도입 1개** + **전개 3개**(활동1, 활동2, 활동3) + **정리 1개**. 해당 차시 주요활동을 달성하기 위해 이 구조로 수업을 설계하세요.
