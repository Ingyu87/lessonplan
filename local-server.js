...
[필수 반영 사항]
1. **연간지도 계획**에 제시된 해당 차시의 "주요 학습 내용 및 활동"을 이 차시 수업의 **핵심 목표**로 삼으세요. 이 주요활동을 달성하기 위한 **3가지 활동**(예: 도입-사전 지식 활성화, 전개1-탐구·활동, 전개2-발표·정리, 정리-마무리)으로 수업을 설계하세요. 해당 차시 주요활동에 맞춰 구체적인 교사 발문·학생 활동을 제시하세요.
...
- **해당 차시 주요활동**을 달성하기 위해 **3가지 활동**으로 수업을 구성하세요: (1) 도입-사전 지식 활성화·탐구 질문 제시, (2) 전개-주요활동 수행(탐구·활동·실습 등), (3) 정리-발표·정리·다음 차시 안내. 도입/전개/정리 단계별로 여러 행을 두세요.
...
마크다운 코드블록 없이 JSON만 반환하세요.
{
  ...
  "activities": [
    ...
    { "단계": "전개", "형태": "모둠", "활동": "모둠 탐구", "교사": "● 탐구 활동1 - 합동의 공통적 성질 찾기\n○ 탐구 자료를 모둠에 배부한다.\n- 도형들을 살펴보고 합동인 것과 합동이 아닌 것을 구분해 보세요.\n- 합동인 예를 관찰하여 합동인 도형의 성질을 최대한 많이 찾아보세요.\n- 각 모둠에서 찾아낸 성질을 살펴보고 '합동'의 개념을 한 문장으로 써 보세요.", "학생": "○ 제시된 도형들을 살펴보고 함께 활동한다.\n- 모양이 같다. 크기가 같다. 포개었을 때 완전히 겹친다. 등\n- 합동은 모양과 크기가 같은 도형이다. 등", "시간": "10", "자료": "", "유의점": "", "평가": "(관찰)" },
    { "단계": "전개", "형태": "전체", "활동": "발표·정리", "교사": "● 탐구 결과 발표 및 정리\n○ 모둠별로 발표하도록 안내한다.\n- ○○○한 모둠부터 발표해 볼까요?\n- 다른 의견은요?", "학생": "○ 모둠별로 발표한다.\n- 찾은 성질을 발표한다. 등", "시간": "10", "자료": "", "유의점": "", "평가": "" },
...
- 교사·학생 열은 문장별로 줄바꿈하고, 각 문장 앞에 기호를 붙인다.
  · ●(채운 원): 주요 활동 제목 (예: ● 사전 지식 활성화하기, ● 탐구 질문 확인하기)
  · ○(빈 원): 구체적 지시·활동 (예: ○ 종이에 도장을 찍고, 펀치로 같은 모양을 만드는 모습을 실물화상기로 제시한다.)
  · -(하이픈): 발문·질문·설명·세부 항목 (예: - 선생님이 지금 무엇을 하고 있나요?)
