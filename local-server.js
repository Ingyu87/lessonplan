...
마크다운 코드블록 없이 JSON만 반환하세요.
{
  ...
  "model": "교수·학습 모형",
  "activities": [
    { "단계": "도입", "형태": "전체", "활동": "사전 지식 활성화하기", "교사": "○○○를 실물화상기로 제시한다. 선생님이 지금 무엇을 하고 있나요? 탐구 질문 확인하기. ○○○는 무엇인가요?", "학생": "학생 예상 반응·할 말", "시간": "3", "자료": "사진·PPT 등 자료명", "유의점": "지도 시 유의사항", "평가": "(관찰) 참여 태도 등" },
    { "단계": "전개", "형태": "모둠", "활동": "모둠 탐구", "교사": "탐구 자료를 모둠에 배부한다. 모둠별로 ○○○를 탐구해 보세요. 어떤 방법으로 확인했나요?", "학생": "구체적 활동·산출", "시간": "10", "자료": "", "유의점": "", "평가": "(관찰)" },
    { "단계": "전개", "형태": "전체", "활동": "발표·정리", "교사": "모둠별로 발표하도록 안내한다. ○○○한 모둠부터 발표해 볼까요? 다른 의견은요?", "학생": "구체적 활동", "시간": "10", "자료": "", "유의점": "", "평가": "" },
    { "단계": "정리", "형태": "전체", "활동": "정리·마무리", "교사": "오늘 배운 내용을 정리한다. 이번 시간에 무엇을 배웠나요? 다음 차시에는 ○○○를 배워봅시다.", "학생": "정리 발표·확인", "시간": "5", "자료": "", "유의점": "", "평가": "" }
  ]
}
activities 필드별 역할(반드시 지킬 것):
- 교사=주요 활동(자료 제시·지도 절차·설명 등) + 발문(질문·할 말). 발문만 적지 말 것. 예: "○종이에 도장을 찍고, 펀치로 같은 모양을 만드는 모습을 실물화상기로 제시한다." "선생님이 지금 무엇을 하고 있나요?"처럼 교사가 하는 구체적 활동을 먼저 쓰고, 그 다음 발문을 적는다.
- 학생=학생 예상 반응·할 말만. 자료=사진·PPT 등 자료명. 유의점=지도 시 유의사항. 평가=(관찰) 등 평가 방법. 서로 섞지 말 것.
